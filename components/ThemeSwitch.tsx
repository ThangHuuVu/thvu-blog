    ...
    <div className="flex items-center ml-4 mr-1">
      ...
      >
        ...
        <span
          ...
          className={`${
            isDark
              ? "translate-x-5 bg-gray-900 border-transparent"
              : "translate-x-0 bg-gray-100 border-transparent"
          }
            pointer-events-none inline-block h-6 w-6 rounded-full border transform ring-0 transition ease-in-out duration-200`}
        >
          <svg
