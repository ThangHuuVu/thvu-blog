...
draft: false
summary: Let's review how I built this site with the help of the public.
images: []
---
...
I add two new features for readers:

- Real-time page view count using [planetscale](https://planetscale.com/) (More on this later in Guestbook section below)
- Reading time. I use [238 WPM as an average for adults](https://digest.bps.org.uk/2019/06/13/most-comprehensive-review-to-date-suggests-the-average-persons-reading-speed-is-slower-than-commonly-thought/)
...
To override the default `/signin` page, create a custom at `pages/signin`.
...
[This snippet](https://leerob.io/snippets/google-analytics) is pretty much everything you need. Notice that now Google is rolling out GAv4 that removed the `View` panel. Therefore, if you want the snippet to work, in your Google Console you need to create a **Universal Analytic Property** and use its ID:
...
The score for accessibility drops at the time of this writing because of [color contrast](https://web.dev/color-contrast/).
