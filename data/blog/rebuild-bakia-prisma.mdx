...
draft: false
summary: Quick tip for typing & interfacin when using Prisma.
images:
  [
...
Bakia is short for "Bất kì ai". In Vietnamese, it means "Anyone". The product is a Ecommerce website that sells custom toys. Features includes:
...
- I already know React.js, and interested in css-in-js approach.
- I was teaching a group of interns in my company about Java Spring Boot and PostgreSQL.
- I have some experience with AWS.

The stack is a classic approach to web development with separate front-end and back-end. It works fine after the first release. However, after a while, I realize as a solo dev, it is hard to manage this stack:

- I found my self having to jump between codebases all the time
...
- Most components are built manually.
...
In this post I will focus on the Prisma techniques I used in Bakia project.

# Building with Prisma

## Benefits

By delegating to Prisma I can focus on on other feature development. Prisma helps me move so much faster:
...
- TypeScript safety. I can ship with confidence and the code is much easier for new maintainer who is familiar with TypeScript.
...
- All the changes in Prisma generated client is immediately reflected and recognized.
